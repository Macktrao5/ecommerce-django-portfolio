...
SECRET_KEY = "django-insecure-s_2l%*51lji&qij&1r67ja(-u8sgamxhk_^4$hwc!payd5gy1y"
...
TEMPLATES = TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'negozio.context_processors.cart_counter',  # <--- Aggiungi questa riga
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = 'supporto@tuonegozio.com'
...
# Diciamo a Django di fidarsi del proxy HTTPS di Render
